...
{
    public class TrainingResultFilterByKnowledgeModel : PageModel
    {
        ...
        {
            var urlTrainingProgram = "https://localhost:44321/api/course-participant/knowledge/";
            var responseTaskTrainingProgram = client.GetAsync(urlTrainingProgram + KnowledgeID);
